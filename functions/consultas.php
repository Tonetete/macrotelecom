...
tipo.nombre AS 'TipoTarea', ta.tipo AS 'TareaCobro', t.unidades AS 'Unidades', (tipo.precioHora*(HOUR(TIMEDIFF(t.horaFin,t.horaInicio)))+(MINUTE(TIMEDIFF(t.horaFin,t.horaInicio))*tipo.precioHora)/60) AS 'Coste', 
ROUND(tipo.precioTarea*t.unidades)   AS 'Comision'
FROM Agentes a, Tareas t, TipoTarea tipo, Perfil p, TareaCobro ta
WHERE t.idAgente = a.idAgente AND t.idTipoTarea=tipo.idTipoTarea AND p.idPerfil=a.idPerfil AND ta.idTareaCobro = tipo.idTareaCobro ";
