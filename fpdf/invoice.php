...
function addEcheance( $date )
{
    ...
    $this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, utf8_decode("FECHA LÍMITE"), 0, 0, "C");
    $this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$date, 0,0, "C");
}
...
function addNumTVA($tva)
{
    ...
    $this->Cell(40, 4, "IVA Intracomunitario", '', '', "C");
    $this->SetFont( "Arial", "", 10);
...
function addCadreEurosFrancs()
{
    ...
    $this->SetFont( "Arial", "B", 6);
    $this->SetXY( $r1, $y1+5 );
    $this->Cell(20,4, "TOTAL BRUTO", 0, 0, "C");
    $this->SetXY( $r1, $y1+10 );
    $this->Cell(20,4, "A CUENTA", 0, 0, "C");
    $this->SetXY( $r1, $y1+15 );
    $this->Cell(20,4, "NETO A PAGAR", 0, 0, "C");
}
function addCadreEuros()
{
    $r1  = $this->w - 70;
    $r2  = $r1 + 60;
    $y1  = $this->h - 40;
...
function addCustomTVAs($total,$cuenta,$neto) {
    ...
    $y1  = $this->h - 40;
     ...
     $this->SetXY( $rf, $y1+5 );
    $this->Cell( 17,4, $total.EURO);
    $this->SetXY( $rf, $y1+10 );
    $this->Cell( 17,4, $cuenta.EURO);
    $this->SetXY( $rf, $y1+14.8 );
    $this->Cell( 17,4, $neto.EURO);
}
